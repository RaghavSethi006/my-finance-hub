...
export const sampleAssets: Asset[] = [
  { id: 'ast-1', name: 'Apple Inc.', type: 'stock', ticker: 'AAPL', exchange: 'NASDAQ', quantity: 15, buyPrice: 142.50, currentPrice: 178.72, currency: 'USD', purchaseDate: '2023-06-15', valueLogs: [{ id: 'ast-1-log-1', date: '2023-06-15', price: 142.50, source: 'import', note: 'Initial purchase' }, { id: 'ast-1-log-2', date: '2024-06-15', price: 166.20, source: 'system', note: 'Mid-year snapshot' }, { id: 'ast-1-log-3', date: '2026-04-20', price: 178.72, source: 'manual', note: 'Manual portfolio refresh' }] },
  { id: 'ast-2', name: 'Tesla Inc.', type: 'stock', ticker: 'TSLA', exchange: 'NASDAQ', quantity: 8, buyPrice: 185.00, currentPrice: 248.42, currency: 'USD', purchaseDate: '2023-09-20', valueLogs: [{ id: 'ast-2-log-1', date: '2023-09-20', price: 185.00, source: 'import', note: 'Initial purchase' }, { id: 'ast-2-log-2', date: '2025-01-10', price: 231.10, source: 'system', note: 'Quarterly mark' }, { id: 'ast-2-log-3', date: '2026-04-19', price: 248.42, source: 'manual', note: 'Manual mark' }] },
  ...
  { id: 'ast-3', name: 'Bitcoin', type: 'crypto', ticker: 'BTC', quantity: 0.25, buyPrice: 27500, currentPrice: 84350, currency: 'USD', purchaseDate: '2023-03-10', valueLogs: [{ id: 'ast-3-log-1', date: '2023-03-10', price: 27500, source: 'import', note: 'Initial purchase' }, { id: 'ast-3-log-2', date: '2024-03-10', price: 52100, source: 'system', note: 'Year-over-year move' }, { id: 'ast-3-log-3', date: '2026-04-22', price: 84350, source: 'manual', note: 'Wallet reconciliation' }] },
  { id: 'ast-4', name: 'Ethereum', type: 'crypto', ticker: 'ETH', quantity: 3.5, buyPrice: 1650, currentPrice: 1870, currency: 'USD', purchaseDate: '2023-04-01', valueLogs: [{ id: 'ast-4-log-1', date: '2023-04-01', price: 1650, source: 'import', note: 'Initial purchase' }, { id: 'ast-4-log-2', date: '2025-12-01', price: 2055, source: 'system', note: 'Winter snapshot' }, { id: 'ast-4-log-3', date: '2026-04-18', price: 1870, source: 'manual', note: 'Manual update' }] },
  ...
  { id: 'ast-5', name: 'Downtown Apartment', type: 'real_estate', quantity: 1, buyPrice: 285000, currentPrice: 312000, currency: 'USD', purchaseDate: '2021-08-15', usefulLifeYears: 30, salvageValue: 240000, valueLogs: [{ id: 'ast-5-log-1', date: '2021-08-15', price: 285000, source: 'import', note: 'Purchase closing value' }, { id: 'ast-5-log-2', date: '2024-08-15', price: 301500, source: 'system', note: 'Appraisal snapshot' }, { id: 'ast-5-log-3', date: '2026-04-20', price: 312000, source: 'manual', note: 'Manual market estimate' }] },
  { id: 'ast-6', name: 'Gold (10g bars)', type: 'gold', quantity: 5, buyPrice: 580, currentPrice: 720, currency: 'USD', purchaseDate: '2022-12-01', valueLogs: [{ id: 'ast-6-log-1', date: '2022-12-01', price: 580, source: 'import', note: 'Initial purchase' }, { id: 'ast-6-log-2', date: '2025-04-01', price: 665, source: 'system', note: 'Commodity update' }, { id: 'ast-6-log-3', date: '2026-04-21', price: 720, source: 'manual', note: 'Spot price note' }] },
  { id: 'ast-15', name: 'Honda Civic 2022', type: 'vehicle', quantity: 1, buyPrice: 28500, currentPrice: 22000, currency: 'USD', purchaseDate: '2022-03-10', notes: 'Depreciating asset', annualDepreciationRate: 9, usefulLifeYears: 8, salvageValue: 12000, valueLogs: [{ id: 'ast-15-log-1', date: '2022-03-10', price: 28500, source: 'import', note: 'Purchase price' }, { id: 'ast-15-log-2', date: '2024-03-10', price: 24500, source: 'system', note: 'Insurance estimate' }, { id: 'ast-15-log-3', date: '2026-04-15', price: 22000, source: 'manual', note: 'Latest resale estimate' }] },
];

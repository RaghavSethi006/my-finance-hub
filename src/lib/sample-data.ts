...
export const sampleAccounts: Account[] = [
  ...
  { id: 'acc-6', name: 'EUR Travel Fund', type: 'bank', balance: 3200.00, currency: 'EUR', color: 'hsl(38 92% 50%)', icon: 'plane', createdAt: '2024-08-01' },
];
...
export const sampleJournalEntries: JournalEntry[] = [
  {
    id: 'je-1', date: d(1), description: 'Monthly salary received',
    entries: [
      { accountName: 'Main Checking', accountType: 'asset', debit: 7500, credit: 0 },
      { accountName: 'Salary Income', accountType: 'income', debit: 0, credit: 7500 },
    ],
    transactionId: 'tx-1',
  },
  {
    id: 'je-2', date: d(0), description: 'Lunch at Chipotle',
    entries: [
      { accountName: 'Food & Dining', accountType: 'expense', debit: 45.50, credit: 0 },
      { accountName: 'Visa Credit Card', accountType: 'liability', debit: 0, credit: 45.50 },
    ],
    transactionId: 'tx-2',
  },
  {
    id: 'je-3', date: d(2), description: 'April rent payment',
    entries: [
      { accountName: 'Rent', accountType: 'expense', debit: 1800, credit: 0 },
      { accountName: 'Main Checking', accountType: 'asset', debit: 0, credit: 1800 },
    ],
    transactionId: 'tx-3',
  },
  {
    id: 'je-4', date: d(0), description: 'Uber rides - weekly',
    entries: [
      { accountName: 'Transport', accountType: 'expense', debit: 120, credit: 0 },
      { accountName: 'Cash Wallet', accountType: 'asset', debit: 0, credit: 120 },
    ],
    transactionId: 'tx-4',
  },
  {
    id: 'je-5', date: d(3), description: 'Freelance web project income',
    entries: [
      { accountName: 'Main Checking', accountType: 'asset', debit: 2200, credit: 0 },
      { accountName: 'Freelance Income', accountType: 'income', debit: 0, credit: 2200 },
    ],
    transactionId: 'tx-5',
  },
  {
    id: 'je-6', date: d(1), description: 'Netflix + Spotify subscription',
    entries: [
      { accountName: 'Entertainment', accountType: 'expense', debit: 65, credit: 0 },
      { accountName: 'Visa Credit Card', accountType: 'liability', debit: 0, credit: 65 },
    ],
    transactionId: 'tx-6',
  },
  {
    id: 'je-7', date: d(3), description: 'Home loan EMI payment',
    entries: [
      { accountName: 'Loan EMI', accountType: 'expense', debit: 1450, credit: 0 },
      { accountName: 'Main Checking', accountType: 'asset', debit: 0, credit: 1450 },
    ],
    transactionId: 'tx-12',
  },
  {
    id: 'je-8', date: d(7), description: 'Dividend payment received',
    entries: [
      { accountName: 'Investment Account', accountType: 'asset', debit: 500, credit: 0 },
      { accountName: 'Investment Returns', accountType: 'income', debit: 0, credit: 500 },
    ],
    transactionId: 'tx-10',
  },
  {
    id: 'je-9', date: d(12), description: 'Logo design freelance income',
    entries: [
      { accountName: 'Main Checking', accountType: 'asset', debit: 1200, credit: 0 },
      { accountName: 'Freelance Income', accountType: 'income', debit: 0, credit: 1200 },
    ],
    transactionId: 'tx-15',
  },
  {
    id: 'je-10', date: d(10), description: 'AWS online course purchase',
    entries: [
      { accountName: 'Education', accountType: 'expense', debit: 320, credit: 0 },
      { accountName: 'Main Checking', accountType: 'asset', debit: 0, credit: 320 },
    ],
    transactionId: 'tx-14',
  },
];
